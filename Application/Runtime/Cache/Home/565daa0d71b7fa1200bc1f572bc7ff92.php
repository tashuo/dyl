...
<header class="navbar navbar-inverse navbar-fixed-top bs-docs-nav" role="banner">
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="#" class="navbar-brand"><img src="/img/love2.jpg" width="100px" height="35px"/>Doyourlove</a>
    </div>
      ...
      <div class="blog_list">
        <?php if(is_array($blogList)): foreach($blogList as $key=>$v): ?><div class="blog">
            ...
            <div class="blog_title">
              <h2 class="text-center"><?php echo ($v["subject"]); ?></h2>
            </div>
            ...
            <div class="blog-bottom">
              <div class="blog_meta">
               <p><a href="javascript:void(0);"  class="pull-left">阅读原文</a><span  class="pull-right"> 热度:<?php echo ($v["views"]); ?></a></p>
              </div>
              <br/>
